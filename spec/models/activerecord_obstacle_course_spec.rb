...
# ========================
  ...
  it '18. returns the names of items for a users order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
      items_for_user_3_third_order = @user_3.orders
                                            .third
                                            .items
                                            .pluck(:name)
    # ------------------------------------------------------------
...
# ========================
  ...
  it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
    orders = Order.where(id: OrderItem.where(item: @item_4).pluck(:order_id))
    # -----------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
    orders = Order.where(user: @user_2, id: OrderItem.where(item: @item_4).pluck(:order_id))
    # -----------------------------------------------------------
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    # Solution goes here
    ordered_items = Item.joins(:orders).group(:name).order(:id)
    # ---------------------------------------------------------------
...
# ========================
  ...
  it '26. returns the names of items that are associated with one or more orders' do
    ...
    ordered_items_names = Item.joins(:orders).group(:name).order(:id).pluck(:name)
    #group and order can be switched, I've put group first as it narrows the number of items
    #then order them after they have been grouped
    # ---------------------------------------------------------------
  ...
  it '27. returns a table of information for all users orders' do
    ...
    custom_results = User.joins(:orders)
                         .select('users.*, COUNT(user_id) AS total_order_count')
                         .group(:user_id)
                         .order(:name)
    # ---------------------------------------------------------------
  ...
  it '29. returns a table of information for all users orders and item counts' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    # User.alias_attribute :user_name, :name
    # Order.alias_attribute :order_id, :id
  ...
  it '30. returns the names of items that have been ordered without n+1 queries' do
    ...
    # ------------------------------------------------------
    orders = Order.includes(:order_items) # Edit only this line
    # ------------------------------------------------------
